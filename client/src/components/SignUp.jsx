    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs px-4">
      ...
      >
        ...
        <div className="text-center mb-6">
          <h2 className="text-2xl font-black text-zinc-900 tracking-tight mb-1">Sign Up</h2>
          <p className="text-zinc-500 text-xs md:text-sm">Create an account to get started.</p>
        </div>
        ...
        <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
          <div className="border border-zinc-200 rounded-xl px-4 py-2.5 focus-within:border-[#0D7AD8] transition-colors">
            <label className="block text-[11px] font-medium text-zinc-400">Username</label>
            <input 
              type="text" 
              value={username}
        ...
        <div className="text-center mt-6 text-xs text-zinc-500">
          ...
          <a href="#login" className="font-bold text-[#0D7AD8] hover:underline">
            Log In
          </a>
        </div>
      </div>
