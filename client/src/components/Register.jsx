    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs px-4">
      ...
      >
        ...
        <div className="text-center mb-6">
          <h2 className="text-2xl font-black text-zinc-900 tracking-tight mb-1">Create Account</h2>
          <p className="text-zinc-500 text-xs md:text-sm">Get started by filling out your details below.</p>
        </div>
        ...
        <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
          <div className="border border-zinc-200 rounded-xl px-4 py-2.5 focus-within:border-emerald-500 transition-colors">
          ...
          <div className="relative border border-zinc-200 rounded-xl px-4 py-2.5 focus-within:border-emerald-500 transition-colors">
          ...
          <button 
            type="submit"
            className="w-full bg-[#10b981] text-white py-3 rounded-xl text-sm font-bold shadow-md hover:bg-emerald-600 transition-colors cursor-pointer mt-2"
          >
            Create Account
          </button>
        </form>
