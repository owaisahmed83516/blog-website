...
const QuizzesSection = () => {
  const quizzesPosts = [
    {
      title: 'Which country do you want to visit the most?',
      excerpt: 'Traveling to a new country is an exciting journey of discovery, offering unfo...',
      author: 'admin',
      date: 'Apr 19, 2026',
      comments: 0,
      views: 45,
    ...
    },
    {
      ...
      excerpt: 'Voting for your favorite movie allows you to have a voice in recognizing and ...',
      author: 'dailynews',
      date: 'Apr 19, 2026',
      comments: 0,
      views: 39,
    ...
    },
    {
      ...
      excerpt: 'Engage in a logical quiz and exercise your critical thinking skills',
      author: 'admin',
      date: 'Apr 19, 2026',
      comments: 0,
      views: 51,
    ...
    },
    {
      ...
      excerpt: 'Test your knowledge as you explore iconic landmarks from around the globe',
      author: 'admin',
      date: 'Apr 19, 2026',
      comments: 0,
      views: 51,
    ...
    },
    {
      ...
      excerpt: 'The solar system is a mesmerizing cosmic arrangement, consisting of the sun, ...',
      author: 'admin',
      date: 'Apr 19, 2026',
      comments: 0,
      views: 45,
    ...
    },
    {
      ...
      excerpt: 'Personality is a unique blend of traits, behaviors, and characteristics that ...',
      author: 'dailynews',
      date: 'Apr 19, 2026',
      comments: 0,
      views: 39,
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="pt-2">
          <div className="border-b border-gray-200 pb-3 mb-6 relative">
            <h2 className="text-xl font-bold text-zinc-900">Quizzes</h2>
            <div className="absolute bottom-0 left-0 w-20 h-0.5 bg-[#0D7AD8]"></div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {quizzesPosts.map((post, index) => (
              <div 
                key={index} 
